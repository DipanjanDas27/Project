...
import { getallappointmentfordoctor, getappointment, gettodayappointment, verifyappointment } from "../controllers/appointment.controller.js";
...
router.route("/todayappointments").get(verifydoctor,gettodayappointment)
